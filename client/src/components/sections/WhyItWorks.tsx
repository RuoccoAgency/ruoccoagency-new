            ...
            return (
              <StaggerItem key={index}>
                <TiltCard className="h-full">
                  <div className="group p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-all duration-300 hover:bg-white/[0.07] backdrop-blur-sm hover:shadow-lg hover:shadow-primary/10 text-center h-full">
