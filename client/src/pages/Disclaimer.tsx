...
export default function Disclaimer() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30 relative">
      <SEO title={policies.disclaimer.title} canonical="/disclaimer" />
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-grow pt-32 pb-24">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold font-display text-white mb-8 text-gradient-logo">{policies.disclaimer.title}</h1>
              
              <div className="prose prose-invert prose-lg max-w-none bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
                {policies.disclaimer.content}
              </div>
            </motion.div>
          </div>
        </main>
