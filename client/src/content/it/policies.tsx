  ...
  terms: {
    ...
    content: (
      <>
        ...
        <h3>2. Descrizione dei Servizi</h3>
        <p>
          RuoccoAgency offre servizi professionali nel campo dell'innovazione digitale, tra cui:
        </p>
        <ul>
          <li>Sviluppo di siti web e Landing Page ottimizzate;</li>
          <li>Ottimizzazione SEO e posizionamento sui motori di ricerca;</li>
          <li>Creazione di chatbot intelligenti e assistenti WhatsApp Business;</li>
          <li>Sviluppo di agenti vocali AI e soluzioni di automazione aziendale.</li>
        </ul>

        <h3>3. Preventivi e Pagamenti</h3>
        <p>
          Ogni progetto viene preceduto da un preventivo dettagliato. I pagamenti devono essere effettuati secondo le modalità e le tempistiche concordate nel contratto specifico o nella proposta accettata. In mancanza di accordi diversi, è previsto un acconto all'avvio dei lavori.
        </p>

        <h3>4. Responsabilità e Consegna</h3>
        <p>
          Ci impegniamo a rispettare le tempistiche di consegna stimate. Tuttavia, tali tempi sono indicativi e possono variare in base alla complessità del progetto e alla tempestività del cliente nel fornire materiali e feedback necessari.
        </p>

        <h3>5. Proprietà Intellettuale</h3>
        <p>
          Tutti i contenuti (testi, grafica, loghi, codice sorgente sviluppato ad hoc) presenti sul sito e nei progetti consegnati sono regolati dalle leggi sul diritto d'autore. Salvo accordi diversi, la proprietà del codice finale passa al cliente solo a saldo avvenuto.
        </p>

        <h3>6. Recesso e Risoluzione</h3>
        <p>
          Il cliente può richiedere l'interruzione dei servizi in qualsiasi momento. In caso di recesso, il cliente sarà tenuto al pagamento del lavoro effettivamente svolto fino a quel momento. RuoccoAgency si riserva il diritto di sospendere i servizi in caso di mancato pagamento o violazione dei presenti termini.
        </p>

        <h3>7. Limitazione di Responsabilità</h3>
        <p>
          RuoccoAgency non sarà responsabile per danni indiretti o perdite di profitto derivanti dall'uso dei servizi o da malfunzionamenti di piattaforme di terze parti (es. WhatsApp, Google, hosting).
        </p>

        <h3>8. Legge Applicabile</h3>
        <p>
          Questi termini sono regolati dalle leggi dello Stato Italiano. Per qualsiasi controversia sarà competente il Foro di Napoli.
        </p>
      </>
    )
  },
  cookie: {
    ...
    content: (
      <>
        ...
        <p>
          Questi cookie sono indispensabili per la navigazione del sito e l'utilizzo delle sue funzionalità. Non identificano l'utente e non richiedono il consenso.
        </p>

        <h4>Cookie Analitici</h4>
        <p>
          Utilizziamo Google Analytics per monitorare come gli utenti interagiscono con il sito. I dati sono raccolti in forma aggregata e anonima per finalità statistiche.
        </p>

        <h4>Cookie di Profilazione e Marketing</h4>
        <p>
          Questi cookie sono utilizzati per tracciare i visitatori attraverso i siti web. L'intento è quello di visualizzare annunci pertinenti e coinvolgenti per il singolo utente (es. Pixel di Meta). Al momento, il nostro sito limita l'uso di tali cookie all'essenziale per l'analisi delle conversioni.
        </p>

        <h3>4. Gestione e Disabilitazione dei Cookie</h3>
        <p>
        ...
        <ul>
          ...
          <li><strong>Apple Safari:</strong> Preferenze &gt; Privacy &gt; Cookie e dati di siti web.</li>
          <li><strong>Microsoft Edge:</strong> Impostazioni &gt; Cookie e autorizzazioni sito.</li>
        </ul>
        <p>
          Nota: disabilitare i cookie tecnici potrebbe compromettere la corretta visualizzazione e funzionalità del sito.
        </p>
